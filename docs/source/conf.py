...
# droughtprediction documentation build
...
from droughtprediction import __version__ as release

# -- Project information -----------------------------------------------------

project = "droughtprediction"
author = "Kedro"
...
htmlhelp_basename = "droughtpredictiondoc"
...
latex_documents = [
    (
        master_doc,
        "droughtprediction.tex",
        "droughtprediction Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "droughtprediction",
        "Project droughtprediction codebase.",
        "Data-Science",
    )
]
